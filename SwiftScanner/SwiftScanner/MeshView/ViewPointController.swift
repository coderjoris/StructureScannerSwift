...
class ViewpointController : NSObject {
    ...
    struct PrivateData {
        ...
        var initialModelViewRotation: GLKMatrix4
        ...
        internal init(screenSizeX: Float, screenSizeY: Float) {
            ...
            initialModelViewRotation = GLKMatrix4Identity
    ...
    deinit {
        self.d = nil
        os_log(.debug, log:OSLog.meshView, "Viewpoint Controller deinit called")
    }
    ...
    func reset() {
        ...
        d!.modelViewRotation = d!.initialModelViewRotation
    ...
    internal func initRotation(xAngleDegrees: Float, yAngleDegrees: Float)
    {
        let radx = Float.pi * xAngleDegrees / 180.0
        let rady = Float.pi * yAngleDegrees / 180.0
        
        let rotX = GLKMatrix4MakeYRotation(radx)
        let rotY = GLKMatrix4MakeXRotation(rady)
        
        d!.modelViewRotation = GLKMatrix4Multiply(rotY, rotX)
        d!.initialModelViewRotation = d!.modelViewRotation
        d!.cameraOrProjectionChangedSinceLastUpdate = true
    }
